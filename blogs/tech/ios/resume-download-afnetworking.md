---
title: iOS 开发：「文件下载、断点下载」的实现（三）：AFNetworking
categories:
  - iOS 开发
tags:
  - 技术
...
- 添加全局 NSURLSessionDataTask、AFURLSessionManager 懒加载代码。这里我把实现「离线断点下载」的代码都放这里了。
...
```objc
/**
 * 点击按钮 -- 使用 AFNetworking 断点下载（支持离线）
 */
