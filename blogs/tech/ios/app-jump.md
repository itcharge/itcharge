...
2. 选择项目 App-B -> TARGETS -> Info -> URL Types -> URL Schemes，设置 App-B 的 URL Schemes 为 AppB。
 [](https://qcdn.itcharge.cn/images/20210729104531.png)

3. 在应用程序 App-A 中添加一个用来点击跳转的 Button，并监听点击事件，添加跳转代码。

 [](https://qcdn.itcharge.cn/images/iOS-Application-jump-001.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Application-jump-002.png)

添加白名单之后在相同的模拟器中先后运行 App-B、App-A，点击按钮，就可以实现跳转了。

具体效果如下图所示。

[](https://qcdn.itcharge.cn/images/iOS-Application-jump-003.gif)
...
1. 首先我们先来为 App-B 搭建两个页面`Page1`和`Page2`。这里用导航控制器 Push 两个 ViewController，通过 Storyboard Segue 设置两个 ViewController 的标识符绑定，分别为"homeToPage1"和"homeToPage2"。
 ...
 [](https://qcdn.itcharge.cn/images/iOS-Application-jump-004.png)

 [](https://qcdn.itcharge.cn/images/iOS-Application-jump-005.png)

2. 在应用程序 App-A 中添加两个用来点击跳转的 Button，一个跳转到 Page1，一个跳转到 Page2，并监听点击事件，添加跳转代码。

[](https://qcdn.itcharge.cn/images/iOS-Application-jump-006.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Application-jump-007.gif)
...
2. 在 App-B 项目中的 Page1 和 Page2 两个页面各添加一个 Button，用于跳转回 App-A。同时添加 Page1 和 Page2 的页面控制器 Page1ViewController 和 Page2ViewController。
 [](https://qcdn.itcharge.cn/images/iOS-Application-jump-008.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Application-jump-009.gif)
