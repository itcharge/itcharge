...
![iOS Member variable 001](https://qcdn.itcharge.cn/images/iOS-Member-variable-001.png)
...
![iOS Member variable 002](https://qcdn.itcharge.cn/images/iOS-Member-variable-002.png)
...
1. 在 `@interface` 和 `@end` 之间声明的成员变量如果不做特别的说明,那么其默认是 `protected` 的
