---
title: iOS 开发：彻底理解 iOS 内存管理（MRC 篇）
categories:
  - iOS 开发
tags:
  - 技术
...
![iOS Memory management 001](https://qcdn.itcharge.cn/images/iOS-Memory-management-001.png)
...
![iOS Memory management 002](https://qcdn.itcharge.cn/images/iOS-Memory-management-002.png)
...
![iOS Memory management 003](https://qcdn.itcharge.cn/images/iOS-Memory-management-003.png)
...
![iOS Memory management 004](https://qcdn.itcharge.cn/images/iOS-Memory-management-004.png)

最后各自实例对象的内存就会被系统回收。

### 3.5.4 一个玩家使用一个游戏房间的情况
...
![iOS Memory management 005](https://qcdn.itcharge.cn/images/iOS-Memory-management-005.png)

当执行完第 10 行代码 `p.room = r;` 时，因为调用了 `setter` 方法，将 Room 实例对象赋值给了 Person 的成员变量，不做其他设置的话，在内存中的表现如下图（做法不对）：

![iOS Memory management 006](https://qcdn.itcharge.cn/images/iOS-Memory-management-006.png)
...
![iOS Memory management 007](https://qcdn.itcharge.cn/images/iOS-Memory-management-007.png)

继续执行第 12 行代码`[r release];`，释放房间，Room 实例对象引用计数 -1，在内存中的表现如下图所示：

![iOS Memory management 008](https://qcdn.itcharge.cn/images/iOS-Memory-management-008.png)
...
![iOS Memory management 009](https://qcdn.itcharge.cn/images/iOS-Memory-management-009.png)

最后实例对象的内存就会被系统回收

### 3.5.5 一个玩家使用一个游戏房间 r 后，换到另一个游戏房间 r2 的情况
...
![iOS Memory management 010](https://qcdn.itcharge.cn/images/iOS-Memory-management-010.png)
...
![iOS Memory management 011](https://qcdn.itcharge.cn/images/iOS-Memory-management-011.png)
...
![iOS Memory management 012](https://qcdn.itcharge.cn/images/iOS-Memory-management-012.png)
...
![iOS Memory management 013](https://qcdn.itcharge.cn/images/iOS-Memory-management-013.png)

### 3.5.6 一个玩家使用一个游戏房间，不再使用游戏房间，将游戏房间释放掉之后，再次使用该游戏房间的情况
...
![iOS Memory management 014](https://qcdn.itcharge.cn/images/iOS-Memory-management-014.png)


然后再执行 ` p.room = r; `，因为 `setter` 方法会将之前的 Room 实例对象先释放掉，此时内存表现为：

![iOS Memory management 015](https://qcdn.itcharge.cn/images/iOS-Memory-management-015.png)
...
// 没有与之对应的自动释放池, 只有在自动释放池中调用 autorelease 才会放到释放池
Person *p = [[[Person alloc] init] autorelease];
[p run];
