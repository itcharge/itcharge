...
# 【OC 语法】iOS 开发：彻底理解 iOS 内存管理（MRC 篇）
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-001.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-002.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-003.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-004.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-005.png)

当执行完第 10 行代码 `p.room = r;` 时，因为调用了 `setter` 方法，将 Room 实例对象赋值给了 Person 的成员变量，不做其他设置的话，在内存中的表现如下图（做法不对）：

[](https://qcdn.itcharge.cn/images/iOS-Memory-management-006.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-007.png)

继续执行第 12 行代码`[r release];`，释放房间，Room 实例对象引用计数 -1，在内存中的表现如下图所示：

[](https://qcdn.itcharge.cn/images/iOS-Memory-management-008.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-009.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-010.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-011.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-012.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-013.png)
...
[](https://qcdn.itcharge.cn/images/iOS-Memory-management-014.png)


然后再执行 ` p.room = r; `，因为 `setter` 方法会将之前的 Room 实例对象先释放掉，此时内存表现为：

[](https://qcdn.itcharge.cn/images/iOS-Memory-management-015.png)
