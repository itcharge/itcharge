...
![iOS YSCDefender 02 001](https://qcdn.itcharge.cn/images/iOS-YSCDefender-02-001.jpg)
...
关系哈希表的数据结构：`{keypath : [KVOInfo 对象 1, KVOInfo 对象 2, ... ]}`
...
- [iOS 中的 crash 防护（三）KVO 造成的 crash](https://blog.csdn.net/hanhailong18/article/details/73034017)
